            ...
            <form>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="1" data-toggle="checkbox" name="can_parttime"
                                        @if($searchCanParttime) checked @endif>
                ...
                <div class="panel panel-default panel-rose">
                    ...
                    <div id="collapseLocation" class="panel-collapse collapse in" role="tabpanel"
                        ...
                        <div class="panel-body">
                            @foreach($filtersPostLevel as $key => $val)
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="{{$val}}" data-toggle="checkbox" name="levels[]"
                                        @if(in_array($val, $levels)) checked @endif>
                                    <span class="checkbox-material"><span class="check"></span></span>
                                    {{__('frontpage.'. $key)}}
                                </label>
                            </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="{{$city}}" data-toggle="checkbox" name="cities[]"
                                        @if(in_array($city, $searchCities)) checked @endif>
                                    <span class="checkbox-material"><span class="check"></span></span>
                                    {{$city}}
                                </label>
                            </div>
