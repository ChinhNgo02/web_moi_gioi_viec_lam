        ...
        <div class="modal-content">
            ...
            <div class="modal-body form-horizontal">
                <div class="form-group">
                    <label>Levels</label>
                    <select class="form-control" name="" id="levels" multiple>
    ...
    $(document).ready(function () {
        ...
        success: function (response) {
            response.data.data.forEach(function (each) {
                ...
                let range_date = (convertDateToRangeDate(each.start_date) && convertDateToRangeDate(each.end_date))
                    ? convertDateToRangeDate(each.start_date) + '-' + convertDateToRangeDate(each.end_date) : '';
